...
#Dev:Muhammad_Zeeshan
##### LOGO #####
logo = """
  ============================================================
|                   ASSALAMU ALAIKUM                          |
|              Coded By : MUHAMMAD ZEESHAN                    |
|      Editing My Script Will Not Make You  a Coder For Haters| 
|         ZEESHAN THE OFFICIAL PROGRAMMER [ A.O.P ]           |
|               FACEBOOK : aamirzk420                   |
  ============================================================
...
print LOGO logo = """
\033[1;32;40mWELCOME__TO___YOUR___DAD___PROFILE
\033[1;32;40mCONTINUE_______ZK_____  
\033[1;32;40mWATCH_THAT
\033[1;32;40m███╗░░░███╗██╗██╗░░██╗
\033[1;32;40m████╗░████║██║╚██╗██╔╝
\033[1;32;40m██╔████╔██║██║░╚███╔╝░
\033[1;32;40m██║╚██╔╝██║██║░██╔██╗░
...
|          THE OFFICIAL PROGRAMMER [ A.O.C]             |
|              FACEBOOK : aamirzk420                    |
  ====================================================== 



CorrectUsername = "mixzk"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username#Dev:Muhammad_Zeeshan
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Muhammad_Zeeshan
	print logo
...
def pilih_super():
	...
	print "\033[1;93m| Having Problem? FB: www.fb.com/aamirzk9211|"
	print "\033[1;32m|-------------------------------------------|"
	print "\033[1;32m| ZEESHAN THE OFFICIAL PROGRAMMER [ A.O.P ] |"
	print "\033[1;32m|-------------------------------------------|"
	...
	print "  \033[1;93m�-------Developed By Muhammad Zeeshan-----�" #Dev:Muhammad_Zeeshan
	print '\033[1;91mProcess Has Been Completed Press Ctrl+Z. Next Type (python2 aoun.py)\033[1;92m....'
	print"\033[1;91mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;91m"+str(len(oks))+"\033[1;97m/\033[1;95m"+str(len(cekpoint))
	print """
           --------Checkpoint ID Open After 7 Days --------
                Facebook Account/ copy this link and open in browser or in a fb comment to join my account.
              \033[1;93mwww.facebook.com/aamirzk420   YOUTUBE Z K TECH"""
